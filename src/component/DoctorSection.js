...
export default function DoctorSection() {
  return (
    <section className="bg-gradient-to-r from-[#197d85]/20 to-[#97a345]/20 mt-30 rounded-2xl p-5 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-8 m-6 md:m-10 lg:m-20">
      {/* Left Content */}
